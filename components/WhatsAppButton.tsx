  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        {/* Tooltip bubble */}
        <div
          className={`absolute right-full mr-3 px-4 py-2 bg-white text-gray-800 text-sm font-medium rounded-lg shadow-lg whitespace-nowrap transition-all duration-300 ${
