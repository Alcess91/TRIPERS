...
export default function ProfilePage() {
  ...
  const profileRedirect = useProfileRedirect() as unknown as ProfileRedirect || {}
  const loading = profileRedirect?.loading ?? false
  const shouldRedirect = profileRedirect?.shouldRedirect ?? false
  ...
  // Afficher un loader si on redirige vers l'onboarding
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            {shouldRedirect ? "Redirection vers la configuration du profil..." : "Chargement..."}
          </p>
        </div>
      </div>
    )
